...
class ParkingOccupancyServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new ParkingOccupancyService(reservationRepository, detectedSpotRepository, parkingRepository);
    }
    ...
    void reconcileParkingUpdatesSpotStatusesAndAvailableSpaces() {
        ...
        var spotA1 = new DetectedSpot(1, "bp-1", "parking-1", 0, 0, 0.1, 0.1, 0.1, 0.1, SpotStatus.FREE);
        ...
        assertEquals(SpotStatus.FREE, spotA2.getStatus());
